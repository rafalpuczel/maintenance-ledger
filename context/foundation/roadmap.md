...
- **Editable email body templates** — Why parked: fixed transactional template for MVP.
...
- **WCAG-AA accessibility, mobile apps, mobile-responsive layout** — Why parked: don't fit the 3-week budget; MVP commits only to keyboard-navigable primary forms on desktop Chrome/Firefox/Safari/Edge.

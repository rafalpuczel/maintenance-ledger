...
- [x] 2.1 Type checking passes: `npx astro check` — b98d5e7
- [x] 2.2 Linting passes (exit code): `npm run lint` — b98d5e7
- [x] 2.3 Build succeeds (editor + sanitizer bundle): `npm run build` — b98d5e7
- [x] 2.4 Existing tests still pass: `npm test` — b98d5e7
...
- [x] 3.1 Type checking passes: `npx astro check` — 869a1f6
- [x] 3.2 Linting passes (exit code): `npm run lint` — 869a1f6
- [x] 3.3 All unit tests pass: `npm test` — 869a1f6
- [x] 3.4 Build succeeds: `npm run build` — 869a1f6
